...
export function buildLaterChapters(g){
 ...
 const sourceHeights=g.spec.chapter===6&&local===1?[515,410,305,200,95,200,310,415]:g.spec.chapter===6&&local===2?[515,410,305,410,305,200,310,415]:profile.heights;
 const heights=sourceHeights.map((y,i)=>local===1&&i>1&&i<6?y-30:y);
 ...
 if(kind==='elite'||g.spec.chapter===6)return;
